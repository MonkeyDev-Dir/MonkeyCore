...
class ClientMonthlyBackups extends Component
{
    ...
    public function render(ClientService $clientService, DatabaseBackupService $backupService): View
    {
        ...
        return view('livewire.clients.client-monthly-backups', [
            'groups' => $backupService->forClientMonthlyHistory($client, $this->projectId),
