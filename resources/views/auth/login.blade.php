                        ...
                        <div>
                            ...
                            <form method="POST" action="{{ route('login') }}" x-data="{ isSubmitting: false }" x-on:submit="isSubmitting = true" :aria-busy="isSubmitting">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            {{ __('auth.login.password_label') }}<span class="text-error-500">*</span>
                                        </label>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div x-data="{ checkboxToggle: false }">
                                            <label for="checkboxLabelOne"
                                                ...
                                                <div class="relative">
                                                    <input type="checkbox" id="checkboxLabelOne" name="remember" value="1" class="sr-only" @checked(old('remember')) @change="checkboxToggle = !checkboxToggle" />
