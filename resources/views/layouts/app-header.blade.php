    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden" src="/images/logo/monkey-mini-bg-clear.webp" alt="Logo" width="40" height="25" />
                <img class="hidden dark:block" src="/images/logo/monkey-mini-bg-dark.webp" alt="Logo" width="40" height="25" />
            </a>
                ...
                <form>
                    <div class="relative">
                        ...
                        <input type="text" placeholder="Search or type command..."
                            class="h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-gray-950 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-[430px]" />
                        <button
