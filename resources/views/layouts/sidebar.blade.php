...
<aside id="sidebar"
    class="fixed flex flex-col mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-60 border-r border-gray-200"
    x-data="{
        openSubmenus: {},
        init() {
                    ...
                    <div>
                        ...
                        <h2 class="mb-4 text-xs uppercase flex leading-[20px] text-gray-400"
                            ...
                            <template x-if="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen">
                                <svg class="size-[18px]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    @if (isset($item['subItems']))
                                        ...
                                        <button @click="toggleSubmenu({{ $groupIndex }}, {{ $itemIndex }})"
                                            ...
                                            <!-- Icon -->
                                            <span class="menu-item-icon" :class="isSubmenuOpen({{ $groupIndex }}, {{ $itemIndex }}) ?
